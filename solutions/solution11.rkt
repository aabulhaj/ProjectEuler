...
(define (diag-sum ls)
  (apply max
         (map *
              (drop-right (car ls) 3)
              (drop-right (drop (cadr ls) 1) 2)
              (drop-right (drop (caddr ls) 2) 1)
              (drop (cadddr ls) 3)
              )
         )
  )
(define (diag-sum-rev ls)
  (apply max
         (map *
              ...
              (drop-right (drop (reverse (cadr ls)) 1) 2)
              (drop-right (drop (reverse (caddr ls)) 2) 1)
              (drop (reverse (cadddr ls)) 3)
              )
         )
  )
(define (diag grid)
...
(max (vertical grid) (horiz grid) (diag grid))
